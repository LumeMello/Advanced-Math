...
long long combination(int n, int r, long long series[]){
    if (r > n){
        return 0;
    }
    if(r == 0 || r == n){
    ...
    return factorial_memorization(n,series)/( factorial_memorization(n-r,series) * factorial_memorization(r, series) );
}
...
int main()
{
    ...
    printf("%lld", combination(18,4,series));
